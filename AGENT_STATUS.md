...
- Branch: `main`
- Current commit: `dff98ccd2bacf2b2ecdd6872faf1dc0210e5dcde`
- Updated: 2026-09-15
...
- status: workspace root symlink escape is now rejected before bubblewrap planning; deterministic regression coverage added
...
- Validate corrected isolation head `dff98ccd2bacf2b2ecdd6872faf1dc0210e5dcde` across the full matrix.
